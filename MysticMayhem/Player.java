...
public class Player implements Serializable {
    ...
    private Vector<Archer> archers = new Vector<>();
    private Vector<Knight> knights = new Vector<>();
    private Vector<Mage> mages = new Vector<>();
    private Vector<Healer> healers = new Vector<>();
    private Vector<MythicalCreature> creatures = new Vector<>();
